...
const RecipeLoading = (props) => {
  return (
    <div className="mt-20 responseBox  mb-20 flex flex-col  align-middle w-9/12 gap-4 rounded-xl bg-neutral-100 p-4 shadow-shadow dark:bg-white/10 dark:text-white">
